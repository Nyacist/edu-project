...
for (let btn of document.querySelectorAll('.buttons-block__button')) {

    if (btn.querySelector('.buttons-block__button_background, .buttons-block__button_border').disabled ) {
        btn.classList.toggle('button-disable');
    }
}
